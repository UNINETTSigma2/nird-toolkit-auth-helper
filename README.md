...
FOr example the pods are in the menu `Workloads`. Select the pods, then click on a pod. A pod's window will open. You can enter the pod by cliking on the small icon with the promt arrow.
